...
export class WebAuthnLogin extends HTMLElement {
  ...
  async _onFormSubmit(event) {
    ...
    try {
      ...
      const decodePublicKeyCredentialRequestOptions = await this._getPublicKeyCredentialRequestOptionsDecoder();
      ...
      this.dispatchEvent(new CustomEvent("assertion-error", { detail: { message: error.message } }));
    }
  }
}
