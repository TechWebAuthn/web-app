...
export class WebAuthnRegister extends HTMLElement {
  ...
  async _onFormSubmit(event) {
    ...
    try {
      ...
      const decodePublicKeyCredentialCreateOptions = await this._getPublicKeyCredentialCreateOptionsDecoder();
      ...
      this.dispatchEvent(new CustomEvent("registration-error", { detail: { message: error.message } }));
    }
  }
}
